...
const StickyNavPill = () => {
    ...
    return (
        <>
            ...
            <div className={`fixed bottom-5 left-1/2 -translate-x-1/2 z-[60] w-full max-w-3xl px-4 transition-all duration-500 transform ${isVisible ? 'translate-y-0 opacity-100' : '-translate-y-24 opacity-0 pointer-events-none'
                }`}>
